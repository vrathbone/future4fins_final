...
prob_industrial_50 <- problem(cost_industrial, features = features_stack_3) %>%
  add_min_set_objective() %>%
...
#Save plot
writeRaster(sprob_industrial_50, here("final_results", "scenario_3_industrial", "sprob_industrial_50_6hr_blm0.tif"), overwrite = TRUE)
```

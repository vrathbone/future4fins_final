...
#Save plot
writeRaster(sprob_industrial_20, here("final_results", "scenario_3_industrial", "sprob_industrial_20_6hr_blm0.000001.tif"), overwrite = TRUE)
```
...
## **STEP 3: Run Some Industrial Fishing Scenarios with efficient boundary penalty (1x10^-6)**
...
## Plot the solution to see what it looks like
plot(sprob_industrial_10_blm,  main = c("industrial- 10% Targets"))
...
## Plot the solution to see what it looks like
plot(sprob_industrial_20_blm,  main = c("industrial- 20% Targets"))
...
## Plot the solution to see what it looks like
plot(sprob_industrial_30_blm,  main = c("industrial- 30% Targets"))
...
## Plot the solution to see what it looks like
plot(sprob_industrial_50_blm,  main = c("industrial- 50% Targets"))

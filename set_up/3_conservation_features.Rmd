...
## mask to the MZ EEZ
aca_coral_aggregate_per <- mask(aca_coral_aggregate_per, mz_eez_buffer_sf)
...
aca_seagrass_aggregate_per <- mask(aca_seagrass_aggregate_per, mz_eez_buffer_sf)
...
features_stack <- stack(aca_coral_raster_agg, mangrove_rast, aca_seagrass_raster_agg, seamount_raster, knolls_raster)
...
writeRaster(features_stack, filename=here("set_up","final_rasters","conservation_features", "multilayer_feature.tif"), options="INTERLEAVE=BAND", overwrite=TRUE)
```

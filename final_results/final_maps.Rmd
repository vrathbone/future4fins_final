...
This Rmarkdown is just to create finalized interactive maps for each scenario.
...
#### **STEP 3: Creating maps for each scenario**
...
## create interactive maps for area
...
## create interactive maps for artisanal 
...
## create interactive maps for industrial 
...
## create interactive maps for combined 
...
## create interactive maps for inverse
...
Scenario 6: Management at 10% and BLM at 0 and 0.0000001
```{r}
### create file path to read in final raster
management_path <- here("final_results", "scenario_6_management")
management_files <- list.files(management_path, full.names = TRUE)

management_10_blm0.000001 <- raster(management_files[1])
plot(management_10_blm0.000001)

management_10_blm0 <- raster(management_files[2])
plot(management_10_blm0)

## create interactive maps for inverse
management_10_blm0.000001_map <- create_map(management_10_blm0.000001, exist_mpas)
management_10_blm0_map <- create_map(management_10_blm0, exist_mpas)

tmap_save(management_10_blm0.000001_map, filename = "final_results/final_maps/inverse_20_blm0.000001_map.html")
tmap_save(management_10_blm0_map, filename = "final_results/final_maps/inverse_20_blm0_map.html")
```

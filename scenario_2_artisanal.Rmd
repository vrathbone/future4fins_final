...
## Solve problem
sprob_artisanal_30 <- solve(prob_artisanal_20)
...
prob_artisanal_10_blm <- problem(cost_artisanal, features = features_stack) %>%
  ...
  add_locked_in_constraints(exist_mpas) %>%
  add_gurobi_solver(gap = 0.01, time_limit = 21600) %>% 
  add_boundary_penalties(penalty = 0.000001) %>%
...
## Save as tif
writeRaster(sprob_artisanal_20_blm, here("final_results", "scenario_2_artisanal", "sprob_artisanal_10_6hr_blm0.000001.tif"), overwrite = TRUE)
```
...
## Save as tif
writeRaster(sprob_artisanal_20_blm, here("final_results", "scenario_2_artisanal", "sprob_artisanal_30_6hr_blm0.000001.tif"), overwrite = TRUE)
```
...
## Save as tiff
writeRaster(sprob_area_20_nompa, here("final_results", "scenario_1_area",  "sprob_artisanal_20_6hr_blm0_nompa.tif"), overwrite = TRUE)
```
...
## Save as tiff
writeRaster(sprob_artisanal_20_blm_nompa, here("final_results", "scenario_1_area",  "sprob_artisanal_20_6hr_blm0.000001_nompa.tif"), overwrite = TRUE)
```

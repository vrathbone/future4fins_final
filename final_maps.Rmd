...
create_map <- function(final_raster, mpas){
  ...
  tm_shape(final_raster, ylim = c(-3402820,-1280921))+
...
```{r}
area_20_blm0[area_20_blm0 == 0] <- NA
  
  tmap_mode("view") # Set to interactive viewing

  tm_shape(area_20_blm0, ylim = c(-3402820,-1280921), xlim = c(3000000,4000000))+
    tm_raster(area_20_blm0[1], palette="dodgerblue3", legend.show = F)+
  tm_shape(mz_eez_sf)+
    tm_borders("black", lwd = .5) +
  tm_basemap("Esri.WorldGrayCanvas")+
    tm_shape(exist_mpas)+

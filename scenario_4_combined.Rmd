...
##1 Royal Penguin
#### BLM: 0.1, Combined, 20% Target, MPAs locked in - 20% target, 6hr time limit
```{r}
...
#Save plot
writeRaster(sprob_combined_20, here("final_results", "sprob_combined_20_6hr_blm0.1.tif"), overwrite = TRUE)

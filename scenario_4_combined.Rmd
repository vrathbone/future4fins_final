...
##3 Dugong
#### BLM: .001, Combined, 20% Target, MPAs locked in - 20% target, 6hr time limit
```{r}
### OBJECTIVE: Minimize combined fishing conflict while meeting 20% representation targets, locking in MPAs, and a boundary penalty of 0.0000001
...
#Save plot
writeRaster(sprob_combined_20, here("final_results", "sprob_combined_20_6hr_blm0.001.tif"), overwrite = TRUE)

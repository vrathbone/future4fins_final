...
prob_combined_20 <- problem(cost_combined, features = features_stack_4) %>%
  ...
  add_locked_in_constraints(exist_mpas_4) %>%
  add_gurobi_solver(gap = 0.01, time_limit = 21600) %>% 
  add_boundary_penalties(0.000005)
...
#Save plot
writeRaster(sprob_combined_20, here("final_results", "sprob_combined_20_6hr_blm0.000005.tif"), overwrite = TRUE)
...
#Save plot
writeRaster(sprob_combined_20, (here("final_results", "sprob_combined_20_6hr_blm0_no-mpas.tif")), overwrite = TRUE)
...
blm0.000003_sf <- rasterToPolygons(blm0.000003, fun = function(sprob_combined_20_6hr_blm1){sprob_combined_20_6hr_blm1==1})
plot(blm1_sf)
shapefile(blm1_sf, here("set_up", "blm_sensitivity", "blm1"))
